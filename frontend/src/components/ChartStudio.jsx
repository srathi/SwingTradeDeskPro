        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 pt-2">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <option value="pocket_pivot">Institutional Pocket Pivot</option>
              <option value="wyckoff_spring">Wyckoff Spring Shakeout</option>
              <option value="nr7_expansion">Toby Crabel NR7 Expansion</option>
